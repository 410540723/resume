	...
	$('#enter').tap(function(){
	    ...
	    $.post('/api/skill',{},function(data){
	        ...
	        for(var i=0;i<data.length;i++){
	          ...
	          dv2.className='dv2';
	          dv2.innerHTML=data[i].level+"<br>"+data[i].name+data[i].category+"<br>"+"使用时间:"+data[i].time;
	          $(nr).append(dv2);
	        }
	    ...
	    $('#jingli').tap(function(){
	       ...
	       $.post('/api/work',{},function(data){
	        ...
	        for(var i=0;i<data.length;i++){
	          ...
	          dvv2.innerHTML=data[i].time;
	          dvv3.innerHTML=data[i].name+"，担任职位是"+data[i].posts+",主要做的项目有"+data[i].projects;
	                $(dvv4).append(dvv2);
	                 $(dvv4).append(dvv3);     
	        }
	        var IScroll=__webpack_require__(8);
	    ...
	    $('#xiangmu').tap(function(){
	       ...
	       $.post('/api/project',{},function(data){
	        ...
	        for(var i=0;i<data.length;i++){
	          ...
	          dvv6.innerHTML=data[i].category;
	          dvv7.innerHTML=data[i].name+"，方式是"+data[i].description+",主要实现的功能有"+data[i].detail;
	                $(dvv8).append(dvv6);
	                 $(dvv8).append(dvv7);     
	        }
	        var IScroll=__webpack_require__(8);
